...
namespace DapperExtensions.Mapper
{
        ...
        where T : class
    {
        ...
        /// </summary>
        public IList<IPropertyMap> Properties { get; } = new List<IPropertyMap>();
        ...
        protected Dictionary<Type, KeyType> PropertyTypeKeyTypeMapping { get; } = new Dictionary<Type, KeyType>
                                             {
        ...
        public virtual void Schema(string schemaName) => SchemaName = schemaName;
        
        public virtual void Table(string tableName) => TableName = tableName;
